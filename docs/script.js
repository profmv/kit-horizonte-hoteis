...
const glossaryEntries = [
  { aliases: ['Power BI'], slug: 'power-bi', tip: 'Ferramenta da Microsoft usada para importar, modelar, calcular e apresentar os dados deste projeto.' },
  { aliases: ['dashboard', 'dashboards'], slug: 'dashboard', tip: 'Painel visual que reúne indicadores e permite explorar a operação da rede Horizonte.' },
  { aliases: ['CSV', 'CSVs'], slug: 'csv', tip: 'Arquivo de dados em texto; é o formato das tabelas que você importará no Power BI.' },
  { aliases: ['ZIP'], slug: 'zip', tip: 'Pacote compactado que reúne os arquivos CSV para download.' },
  { aliases: ['PMS'], slug: 'pms', tip: 'Sistema de gestão hoteleira que registra reservas, hóspedes, quartos e estadias.' },
  { aliases: ['OTA', 'OTAs'], slug: 'ota', tip: 'Agência de viagem on-line; no projeto, é um canal de venda que cobra comissão.' },
  { aliases: ['Analytics'], slug: 'analytics', tip: 'Uso dos dados para encontrar padrões, explicar resultados e recomendar ações.' },
  { aliases: ['ADR'], slug: 'adr', tip: 'Diária média vendida: receita de hospedagem dividida pelas diárias vendidas.' },
  { aliases: ['RevPAR'], slug: 'revpar', tip: 'Receita por quarto disponível; combina preço e ocupação em um único indicador.' },
  ...
  { aliases: ['SLA'], slug: 'sla', tip: 'Prazo acordado para resolver um chamado de manutenção conforme sua prioridade.' },
  ...
  { aliases: ['PK'], slug: 'pk', tip: 'Chave primária: coluna que identifica cada linha de uma tabela sem repetição.' },
  { aliases: ['FK', 'FKs'], slug: 'fk', tip: 'Chave estrangeira: coluna que aponta para a chave primária de outra tabela.' },
  ...
  { aliases: ['DAX'], slug: 'dax', tip: 'Linguagem de fórmulas do Power BI usada para criar medidas e indicadores.' },
  { aliases: ['medida', 'medidas'], slug: 'medida', tip: 'Cálculo dinâmico em DAX que responde aos filtros aplicados ao relatório.' },
  { aliases: ['KPI', 'KPIs'], slug: 'kpi', tip: 'Indicador-chave usado para acompanhar desempenho e apoiar decisões.' },
  ...
  { aliases: ['JSON'], slug: 'json', tip: 'Formato de texto usado aqui para importar a paleta visual como tema do Power BI.' },
  { aliases: ['.PBIX', 'PBIX'], slug: 'pbix', tip: 'Arquivo do Power BI Desktop que contém consultas, modelo, medidas e páginas do relatório.' },
  { aliases: ['ETL'], slug: 'etl', tip: 'Processo de extrair, transformar e carregar dados; neste projeto acontece no Power Query.' },
